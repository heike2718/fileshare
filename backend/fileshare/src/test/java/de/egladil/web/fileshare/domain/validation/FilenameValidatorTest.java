...
public class FilenameValidatorTest {
    ...
    class DefaultAnnotationTests {
        ...
        void should_not_pass_when_too_long() {
            ...
            final ConstraintViolation<DefaultFilenameValidatorTestBean> violation = violations.iterator().next();
    ...
    class CustimizedAnnotationTests {
        ...
        void should_not_pass_when_too_long() {
            ...
            final ConstraintViolation<CustomizedFilenameValidatorTestBean> violation = violations.iterator().next();
