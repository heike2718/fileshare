...
public class FileshareResourceAuthorizationTest {
    ...
    void should_listFiles_be_forbidden() {
        ...
        given().accept("application/json").get().then().statusCode(403);
    }
    ...
    void should_upload_be_forbidden() {
        ...
        // act
        given().contentType("application/json").accept("application/json").body(fileDto).post().then().statusCode(403);
    }
    ...
    void should_download_be_forbidden() {
        ...
        // act
        given().accept("application/json").get("abcde").then().statusCode(403);
    }
    ...
    void should_delete_be_forbidden() {
        ...
        // act
        given().accept("application/json").delete("abcde").then().statusCode(403);
    }
