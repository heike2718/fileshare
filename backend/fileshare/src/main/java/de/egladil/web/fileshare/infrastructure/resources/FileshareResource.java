...
public class FileshareResource {
    ...
    @GET
    @Path("{id}")
    public FileDto downloadFile(@PathParam(value = "id") @Pattern(
            regexp = ValidationPatternsAndMessages.VALID_ID,
            message = ValidationPatternsAndMessages.INVALID_ID_MESSAGE) String id) {
    ...
    @DELETE
    @Path("{id}")
    public Response deleteFile(@PathParam(value = "id") @Pattern(
            regexp = ValidationPatternsAndMessages.VALID_ID,
            message = ValidationPatternsAndMessages.INVALID_ID_MESSAGE) String id) {
