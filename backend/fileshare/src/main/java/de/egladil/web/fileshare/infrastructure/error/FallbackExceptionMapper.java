...
public class FallbackExceptionMapper implements ExceptionMapper<RuntimeException> {
  ...
  public Response toResponse(final RuntimeException exception) {
    ...
    final ErrorResponseDto errorResponseDto = ErrorResponseDto.builder().errorLevel(ErrorLevel.ERROR).message("""
                Ein unerwarteter Fehler ist aufgetreten.
                Wende Dich bitte vertrauensvoll an Deinen technischen Support,
                wenn möglich mit Kontext und Screenshots.""").build();
