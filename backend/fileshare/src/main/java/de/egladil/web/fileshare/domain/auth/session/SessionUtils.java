...
public final class SessionUtils {
     ...
     *
     * @param sessionIdleTimeoutMinutes Integer Anzahl Minuten, nach denen eine
     *                                  Session als idle weggeräumt wird.
     * @return long
     */
     ...
     * @return boolean
     */
    public static boolean isSessionExpieredOrDead(LocalDateTime now, Session session, Integer maxSessionSeconds) {
