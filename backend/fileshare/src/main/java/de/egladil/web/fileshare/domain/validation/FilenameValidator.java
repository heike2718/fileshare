...
public class FilenameValidator implements ConstraintValidator<ValidFilename, String> {
    ...
    // Windows-reservierte Gerätenamen (case-insensitive) – sonst knallt es auf Windows
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
      ...
      // Windows: "CON.txt" ist auch verboten (Reserved names gelten vor dem ersten Punkt)
